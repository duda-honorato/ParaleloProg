...
O método baseia-se na geração de pontos aleatórios dentro de um quadrado unitário e na verificação de quantos pontos caem dentro de um quarto de círculo inscrito. A aproximação de π é dada por:
π ≈ 4 × (Número de pontos dentro do círculo) / (Total de pontos)
